...
│   ├── LP-Improve Your Business with Excellent Customer Service.docx     Lesson Plan (+ PDF)
│   └── LG-Improve Your Business with Excellent Customer Service.docx     Learner Guide (+ PDF)
...
|---|---|---|---|---|
| 1 | Mapping the Service Chain at a Singapore Bank Branch | 1 | Case Study + Peer Sharing | 30 |
| 2 | Attitude and Positive Language at a Changi Airport Service Counter | 2 | Role Play + Peer Sharing | 25 |
| 3 | Diagnosing Customer Needs at a Growing SME — TechNova Account Review | 3 | Case Study + Role Play | 35 |
| 4 | The Walk-In Interruption — Retail Service Counter, Bugis | 4 | Role Play | 25 |
| 5 | The Angry Delivery Call — Logistics Hotline | 5 | Role Play | 30 |
| 6 | Rewriting the Refund Email — E-Commerce Support Inbox | 6 | Case Study + Practical Writing | 25 |
| 7 | Closing the Loop — F&B Chain Losing Repeat Customers | 7 | Case Study + Group Presentation | 40 |
| 8 | Service Recovery Under Pressure — The Wedding Catering Failure | 8 | Role Play + Case Study | 35 |
| 9 | Drawing the Line — Escalation and Abuse at a Service Counter | 9 | Role Play + Decision Exercise | 30 |
